...

                                {
                                  ...
                                  },
                                  {
                                    ...
                                    },
                                    {
                                      id: 'FeelSickChoice',
                                      options: [
                                        {  label: 'ขอบคุณนะ Mindbot', trigger:'NeedHelp'},    
                                        {  label: 'ขอบคุณค่ะ', trigger:'NeedHelp'},                   
                                      ],
                                    },
                                    {
                                      id: 'NeedHelp',
                                    ...
                                    },
                                    {
                                      id: 'NeedHelpChoice',
                                      options: [
                                        {  label: 'ฉันแค่อยากเล่าให้ฟังเฉยๆ', trigger:'TellStory'},    
                                    ...
                                    },
                                    {
                                      ...
                                      options: [
                                        {  label: 'เข้าใจแล้ว Mindbot', trigger:'TellStory'},                    
                                      ],
                                    },
                                    {
                                    ...
                                    },
                                    {
                                      ...
                                      },
                                      {
                                        ...
                                        options: [
                                          {  label: 'เริ่มเลย Mindbot', trigger:'MeditationChoice3'},                  
                                        ],
                                      },
